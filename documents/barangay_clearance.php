...
<body>
	...
	<!-- PRINT BUTTON -->
	<button id="printBtn">🖨️ Print Barangay Clearance</button>
	...
	<div id="print-area" style="width: 8.5in; height: 11in; padding: 60px; border: 2px solid #000; margin: auto; position: relative; box-sizing: border-box; background-color: #fff;">
		...
		<div style="text-align: center; line-height: 1.3; position: relative;">
			...
			<h2 style="text-decoration: underline; font-weight: bold; margin: 10px 0;">BARANGAY CLEARANCE</h2>
		</div>
		...
		<div style="margin-top: 40px; text-align: justify; font-size: 16px; line-height: 1.8;">
			...
			<p style="text-indent: 60px;">
				...
				of legal age, <?= $gender ?>, and a resident of <span style="font-weight: bold;"><?= $address ?></span>,
				is known to be a person of good moral character and a law-abiding citizen of this barangay.
			</p>

			<p style="text-indent: 60px;">
				This certification is issued upon the request of the above-named person for whatever legal purpose it may serve him/her.
			</p>
